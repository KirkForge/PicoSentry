"""Shared policy primitives for the Pico Security Series.
...
class PolicyBase(ABC):  # rationale: abstract base for policy-as-code, shared across PicoDome and PicoSentry
